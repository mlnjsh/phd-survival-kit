<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=28&duration=3000&pause=1000&color=2E86AB&center=true&vCenter=true&multiline=true&repeat=true&width=700&height=100&lines=%F0%9F%93%9A+PhD+Survival+Kit;Everything+Nobody+Tells+You+About+a+PhD" alt="PhD Survival Kit" />
</p>

<h1 align="center">📚 PhD Survival Kit</h1>

<h3 align="center"><em>Everything Nobody Tells You About Surviving (and Thriving in) a PhD</em></h3>

<p align="center">
  <a href="#-contributing"><img src="https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat-square" alt="Contributions Welcome"></a>
  <a href="https://github.com/mlnjsh/phd-survival-kit/stargazers"><img src="https://img.shields.io/github/stars/mlnjsh/phd-survival-kit?style=flat-square&color=yellow" alt="Stars"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue.svg?style=flat-square" alt="License MIT"></a>
  <a href="https://scholar.google.com"><img src="https://img.shields.io/badge/papers%20published-15%2B-orange?style=flat-square" alt="Papers Published 15+"></a>
  <a href="#-how-i-got-my-best-paper-award--behind-the-scenes"><img src="https://img.shields.io/badge/best%20paper%20award-ICIVC%202021-red?style=flat-square" alt="Best Paper Award"></a>
  <a href="#"><img src="https://img.shields.io/badge/indexed-SCI%20%7C%20SCIE%20%7C%20Scopus-purple?style=flat-square" alt="SCI/SCIE/Scopus"></a>
</p>

<p align="center">
  <strong>By <a href="https://github.com/mlnjsh">Prof. Milan Amrut Joshi</a></strong> — Researcher in TDA, Optimization & Machine Learning
</p>
...
```
    ╔══════════════════════════════════════════════════════════════╗
    ║                                                              ║
    ║   "The PhD is not about proving you're smart.                ║
    ║    It's about proving you can keep going                     ║
    ║    when everything is confusing."                            ║
    ║                                                              ║
    ║                        — Every PhD survivor, ever            ║
    ║                                                              ║
    ╚══════════════════════════════════════════════════════════════╝
```
...
When I started my PhD, I had no idea what I was doing. I didn't know how to structure a paper. I didn't know what "Reviewer 2" meant (oh, I learned). I didn't know that getting rejected wasn't the end of the world — it was just Tuesday. I didn't know that the hardest part of a PhD isn't the research itself; it's everything *around* the research that nobody teaches you.
...
It's not a textbook. It's not some sanitized "guide to academic excellence." It's the real, practical, sometimes messy truth about how research actually works — written by someone who has been through it and is still going through it.

Whether you're a first-year PhD student staring at a blank LaTeX document, a postdoc trying to survive the publish-or-perish treadmill, or a seasoned researcher who just wants better templates — there's something here for you.
...
- [📝 How to Write a Research Paper](#-how-to-write-a-research-paper)
  - [Finding a Research Gap](#1-finding-a-research-gap)
  - [Structuring Your Paper (IMRaD)](#2-structuring-your-paper-imrad-format)
  - [Writing the Abstract](#3-writing-the-abstract)
  - [Literature Review Strategy](#4-literature-review-strategy)
  - [Methodology Section Tips](#5-methodology-section-tips)
  - [Results Presentation](#6-results-presentation)
  - [Common Mistakes to Avoid](#7-common-mistakes-to-avoid)
  - [My Personal Workflow](#8-my-personal-workflow)
- [📬 How to Respond to Reviewers](#-how-to-respond-to-reviewers)
  - [Anatomy of a Reviewer Response Letter](#anatomy-of-a-reviewer-response-letter)
  - [Template for Point-by-Point Responses](#template-for-point-by-point-responses)
  - [Handling Unfair or Harsh Reviews](#handling-unfair-or-harsh-reviews)
  - [The "Reviewer 2" Survival Guide](#the-reviewer-2-survival-guide)
  - [When to Push Back vs. When to Comply](#when-to-push-back-vs-when-to-comply)
- [🎤 How to Give a Great Research Talk](#-how-to-give-a-great-research-talk)
  - [Slide Design Principles](#slide-design-principles)
  - [The 10-20-30 Rule for Academia](#the-10-20-30-rule-adapted-for-academia)
  - [Handling Q&A Like a Pro](#handling-qa-like-a-pro)
  - [Conference vs. Thesis Defense](#conference-presentation-vs-thesis-defense)
  - [What I Learned from Bombing My First Talk](#what-i-learned-from-bombing-my-first-talk)
- [🏆 How I Got My Best Paper Award](#-how-i-got-my-best-paper-award--behind-the-scenes)
- [📐 LaTeX Templates](#-latex-templates)
- [✅ Checklists](#-checklists)
- [🔄 Research Methodology Flowcharts](#-research-methodology-flowcharts)
- [🛠️ Essential Tools for Researchers](#%EF%B8%8F-essential-tools-for-researchers)
- [📚 Recommended Books](#-recommended-books)
- [🎯 Journal Selection Guide](#-journal-selection-guide)
- [💡 PhD Life Tips](#-phd-life-tips)
...
The research gap is the foundation of your entire paper. Without a clear gap, you don't have a contribution — you have a homework assignment.
...
| **Limitation mining** | In every paper you read, highlight the "Limitations" and "Future Work" sections | Keep a running document of these — your next paper is hiding in there |
...
1. **What exists?** (Current state of the art)
2. **What's missing?** (The gap — be specific)
3. **Why does it matter?** (The "so what?" factor)

If you can't answer all three clearly in 2-3 sentences each, your gap isn't sharp enough yet.

### 2. Structuring Your Paper (IMRaD Format)
...
┌─────────────────────────────────────────────────────┐
│                    TITLE                             │
│           (Specific, Informative, <15 words)        │
├─────────────────────────────────────────────────────┤
│                   ABSTRACT                          │
│         (Self-contained, 150-250 words)             │
├─────────────────────────────────────────────────────┤
│                INTRODUCTION                         │
│  • What's the problem?                              │
│  • Why does it matter?                              │
│  • What has been done before? (Brief)               │
│  • What's still missing? (THE GAP)                  │
│  • What do you propose? (Your contribution)         │
│  • How is the paper organized?                      │
├─────────────────────────────────────────────────────┤
│              RELATED WORK / LITERATURE REVIEW        │
│  • Organized by themes, NOT chronologically         │
│  • Show how your work fits into the landscape       │
│  • End with what's missing (reinforces YOUR gap)    │
├─────────────────────────────────────────────────────┤
│                 METHODOLOGY                         │
│  • Problem formulation (math, definitions)          │
│  • Your proposed approach (step by step)            │
...
│  • Why does your method work (or not)?              │
│  • Limitations (be honest)                          │
│  • Broader implications                             │
├─────────────────────────────────────────────────────┤
│                 CONCLUSION                          │
│  • Summary of contributions (not results!)          │
│  • Future directions                                │
│  • Final takeaway                                   │
├─────────────────────────────────────────────────────┤
│                 REFERENCES                          │
│  (Formatted per journal style, 30-60 refs typical)  │
└─────────────────────────────────────────────────────┘
```

**Pro tip:** Write the sections in this order: **Methodology -> Results -> Introduction -> Related Work -> Discussion -> Conclusion -> Abstract -> Title**. Yes, write the abstract last. You can't summarize something you haven't written yet.
...
Start Paper (seminal work in your area)
    │
    ├── Forward snowball: Who cited this paper?
    │   └── Find recent papers building on this work
    │
    └── Backward snowball: What does this paper cite?
        └── Find foundational works you might have missed
```

**My literature review workflow:**

1. **Google Scholar** — Start with 5-10 keywords. Sort by date for recent work, by citations for seminal work.
2. **Connected Papers** (connectedpapers.com) — Paste a key paper's URL. Get a visual graph of related papers. This tool is gold.
3. **Semantic Scholar** — Better than Google Scholar for finding the *most relevant* papers, not just the most cited.
4. **arXiv** — For cutting-edge preprints (especially in ML/AI). Check weekly.
5. **Reference tracking** — When you find a great paper, look at its references AND who cited it.
...
### 5. Methodology Section Tips

This is where your actual contribution lives. Make it crystal clear.

**Rules for a good methodology section:**

1. **Start with problem formulation.** Define your inputs, outputs, objective function. Use math notation consistently.
2. **Use a framework diagram.** A single clear figure explaining your pipeline is worth 1000 words.
3. **Be reproducible.** Someone should be able to reimplement your method from this section alone.
4. **Number your equations.** Only number the ones you reference later.
5. **Explain your design choices.** Don't just say "we use ReLU activation" — say *why* you chose ReLU over alternatives.
...
1. **Overclaiming.** "Our method is the best" vs. "Our method outperforms baselines on X dataset under Y conditions." Be precise.
2. **Weak baselines.** Comparing against outdated methods to look good. Reviewers will catch this every time.
3. **No ablation study.** If you have a multi-component method and don't show what each component contributes, expect Reviewer 2 to demand it.
4. **Copy-paste literature review.** Listing papers like "A did X. B did Y. C did Z." Instead, synthesize: "Approaches to X can be categorized into three families..."
5. **Ignoring related work.** If a reviewer finds a relevant paper you didn't cite, they'll assume you didn't do your homework.
6. **Poor writing quality.** Grammar issues, typos, and unclear sentences signal carelessness. Use Grammarly + have a colleague proofread.
7. **Figures that need a magnifying glass.** If text in your figures is smaller than the paper body text, it's too small.

### 8. My Personal Workflow
...
### Anatomy of a Reviewer Response Letter
...
### Template for Point-by-Point Responses
...
You can find the full template at [`templates/reviewer_response.tex`](templates/reviewer_response.tex).

### Handling Unfair or Harsh Reviews

Let's be real — sometimes reviews are unfair. Here's how to handle it:
...
```
    ...
    1. DENIAL     →  "There's no way they actually read my paper."
    2. ANGER      →  "WHO REVIEWS A PAPER LIKE THIS?!"
    3. BARGAINING →  "Maybe if I just address points 1 and 3..."
    4. DEPRESSION →  "My research is worthless. I should quit."
    5. ACCEPTANCE  →  "Okay, some of these points are actually fair."
                      "Let me fix this and resubmit."
```

**Real talk:** In my experience, about 70% of "Reviewer 2" comments — even the harsh ones — contain actionable feedback that genuinely improves the paper. The remaining 30%? You respond to them professionally, make reasonable changes, and write a clear explanation of your position.
...
- "We disagree." (Too blunt — use "We would like to respectfully offer an alternative perspective...")
...
```
                    ...
                    └────────┬──────────┘
                       ...
                       YES       NO
                        │         │
                ┌───────┴──┐  ┌──┴────────────┐
                │ Does it   │  │ Can you prove  │
                │ improve   │  │ them wrong     │
                │ the paper?│  │ with evidence? │
                └─────┬─────┘  └──────┬────────┘
                  ┌───┴───┐      ┌────┴────┐
                 YES     NO     YES       NO
                  │       │      │         │
              ┌───┴───┐ ┌┴────┐ ┌┴─────┐  ┌┴──────────┐
              │ DO IT │ │Make │ │Push  │  │ Make a     │
              │ gladly│ │small│ │back  │  │ compromise │
              │       │ │tweak│ │with  │  │ and        │
              └───────┘ │move │ │proof │  │ explain    │
                        │ on  │ └──────┘  └────────────┘
                        └─────┘
...
Slides 2-3:  Motivation — Why should the audience care?
Slide 4:     Problem statement — What are we solving?
Slide 5:     Key insight — The "aha!" moment
Slides 6-8:  Method overview — How your approach works
Slides 9-11: Results — The goods (key figures and tables only)
Slide 12:    Comparison — How you beat the baselines
Slide 13:    Conclusion — 3 bullet points max
...
### Conference Presentation vs. Thesis Defense
...
### What I Learned from Bombing My First Talk
...
>
> 1. **Fewer slides, more depth.** 15 slides for 15 minutes, not 35.
> 2. **Practice out loud.** Reading slides silently is NOT practice. Stand up, talk to a wall if you have to.
> 3. **Time yourself.** Practice with a timer, every single time.
> 4. **Know your baselines cold.** If you compare against Method X, you better be able to explain Method X.
> 5. **Nobody remembers your bad talk as much as you do.** I've never had someone say "Hey, weren't you the person who bombed that talk in 2019?" It only lives in your head.
>
> My talks got much better after that. Failure is a teacher, not a sentence.

---

## 🏆 How I Got My Best Paper Award — Behind the Scenes

At **ICIVC-2021** (International Conference on Image and Vision Computing) in Oman, I received the **Best Paper Award** for my work on TDA-based feature extraction. Here's the real story — not the polished version, but the messy truth.
...
1. **Pivoting venues quickly.** After the desk rejection, I didn't mope for months. I revised the framing within two weeks and found a better-fit venue.
2. **Investing in figures.** I spent significant time creating clear, intuitive diagrams that explained the TDA pipeline visually. The reviewers specifically praised the figures.
3. **Honest limitation discussion.** I didn't oversell. I clearly stated where the method works and where it doesn't. Reviewers appreciated the honesty.
4. **Strong baselines.** I compared against the actual state-of-the-art, not weak strawman methods.

### Lessons Learned (Actionable Takeaways)

1. **Rejection is redirection.** The desk rejection forced me to reframe the paper, which actually made it stronger.
2. **Visuals sell ideas.** Reviewers and audiences understand diagrams faster than equations.
3. **Explain your work to a non-expert.** If your mother/friend can understand the *idea* (not the math), your explanation is good enough.
4. **Don't wait for perfection.** My paper wasn't perfect when I submitted. No paper ever is. "Good enough to submit" is a real threshold.
5. **Awards are nice, but they're not the goal.** The real reward was the knowledge I gained and the connections I made at the conference.
...
|----------|------|-------------|
| IEEE Conference/Journal | `templates/ieee_paper.tex` | Standard IEEE two-column format |
| Springer LNCS | `templates/springer_lncs.tex` | Lecture Notes in Computer Science format |
| Beamer Presentation | `templates/beamer_talk.tex` | Clean, minimal academic talk template |
| Journal Cover Letter | `templates/cover_letter.tex` | Submission cover letter template |
| Reviewer Response | `templates/reviewer_response.tex` | Point-by-point response letter |
| PhD Thesis | `templates/thesis_template.tex` | Chapter-based thesis structure |

### Quick-Start: IEEE Paper
...
Use this before submitting ANY paper. Print it out if you have to.
...
```
    ┌──────────┐
    │  IDEA    │ ← Literature review, experiment observation,
    │  SPARK   │   advisor suggestion, shower thought
    └────┬─────┘
         │
         ▼
    ┌──────────┐     ┌──────────────┐
    │ VALIDATE │────▶│ Is it novel? │
    │ THE IDEA │     │ Is it useful?│
    └────┬─────┘     └──────┬───────┘
         │                   │
         │              NO ──┘── YES
         │              │         │
...
### Literature Review Strategy Flowchart

```
    ┌─────────────────────────────┐
    │ START: Define your topic    │
    │ and 5-10 key search terms   │
    └──────────────┬──────────────┘
                   │
                   ▼
    ┌─────────────────────────────┐
    ...
    └──────────────┬──────────────┘
                   ...
                   ▼
    ┌─────────────────────────────┐
    │ Read abstracts of top 30    │
    │ Select 10-15 most relevant  │
    └──────────────┬──────────────┘
                   │
                   ▼
    ┌─────────────────────────────┐
    │ Deep-read the 10-15 papers  │
    │ Note: methods, results,     │
...
### "Should I Submit to This Journal?" Decision Tree
...
```
    ...
    └───────────────┬──────────────────┘
               ...
               YES      NO
                ...
                ▼     ▼
    ┌──────────────────────────────────┐
    │ Is the scope relevant to         │
    │ your paper topic?                │
    └───────────────┬──────────────────┘
                ┌───┴───┐
               YES      NO → FIND ANOTHER JOURNAL
                │
                ▼
    ┌──────────────────────────────────┐
    │ Check for predatory signals:     │
    │ • Unsolicited email invitation?  │
    │ • Unrealistic review time?       │
    │ • No clear editorial board?      │
    │ • Excessive APCs?                │
    └───────────────┬──────────────────┘
                ┌───┴───┐
             CLEAN    RED FLAGS → DO NOT SUBMIT
                │
                ▼
    ┌──────────────────────────────────┐
    │ Is the impact factor / CiteScore│
    │ reasonable for your career stage?│
    └───────────────┬──────────────────┘
                ┌───┴───┐
               YES      NO (too high?)
                │        │
                ...
                ▼
    ┌──────────────────────────────────┐
    │ What's the typical review time?  │
    │ Can you wait that long?          │
    └───────────────┬──────────────────┘
                ┌───┴───┐
               YES      NO → Consider a faster venue
                │
                ▼
          ┌────────────┐
          │  SUBMIT!   │
...
### Reviewer Response Decision Tree

```
    ┌──────────────────────────────┐
    │ Read reviewer comment        │
    │ (after 24h cooling period)   │
    └──────────────┬───────────────┘
                   │
                   ▼
    ┌──────────────────────────────┐
    ...
    └───────┬──────┘ └────────┬─────────┘
       ...
       YES     NO       YES     NO
        ...
        ▼       ▼        ▼       ▼
    ┌──────┐┌──────┐┌───────┐┌────────────┐
    │Fix it││Add   ││Clarify││Politely    │
    │thank ││expts/││your   ││disagree    │
    │them  ││analysis│text  ││with        │
    │      ││explain │      ││evidence    │
    └──────┘│scope ││      │└────────────┘
            └──────┘└───────┘
```
...
## 🛠️ Essential Tools for Researchers
...
| **Sci-Hub** | — | You didn't hear this from me. |
...
### AI Assistants for Research (Ethical Use)
...
### On Thinking & Research Methodology
...
### SCI vs. SCIE vs. Scopus — What Actually Matters
...
```
    ...
    │  │  • The "original" prestigious index          │    │
    │  │  • ~3,700 journals                           │    │
    │  │  • Highest prestige                          │    │
    │  └─────────────────────────────────────────────┘    │
    │  ┌─────────────────────────────────────────────┐    │
    ...
    │  │  • Broader coverage                          │    │
    │  │  • ~9,200 journals                           │    │
    │  │  • Same database, more inclusive              │    │
    │  │  • Most institutions treat SCIE = SCI        │    │
    │  └─────────────────────────────────────────────┘    │
    └─────────────────────────────────────────────────────┘

    ┌─────────────────────────────────────────────────────┐
    │                    SCOPUS                            │
    │  • Run by Elsevier (separate from WoS)              │
    │  • ~27,000 journals (broadest coverage)             │
    │  • Many journals are in both Scopus AND SCI/SCIE    │
    │  • Some institutions value Scopus equally            │
    └─────────────────────────────────────────────────────┘
```

**Practical advice:** For most academic purposes (hiring, promotion, PhD requirements), SCI/SCIE and Scopus-indexed publications all count. Check your specific institution's requirements. Don't get caught up in the SCI vs. SCIE distinction — most places treat them the same.
...
1. Check if it's listed in **Scopus** (scopus.com/sources) or **Web of Science** (mjl.clarivate.com)
2. Search it on **DOAJ** (doaj.org) for verified open-access journals
3. Check **Beall's List** (beallslist.net) for known predatory publishers
4. Ask your advisor or senior colleagues
...
### My Publication Journey — Where I Submitted and Why
...
1. **Communicate proactively.** Don't wait for your advisor to check in. Send weekly updates, even if they're short.
2. **Manage up.** Your advisor is busy. Prepare meeting agendas. Come with specific questions, not vague "I'm stuck."
3. **Understand their incentives.** Advisors need papers, grants, and student success. Align your goals with theirs when possible.
4. **Document everything.** Decisions, deadlines, agreed milestones. "As discussed in our meeting, I will..." emails are your friend.
5. **Disagree respectfully.** You're allowed to push back on your advisor's suggestions. Frame it as "I see your point, but I've been thinking about X because..."
6. **Be visible.** Attend lab meetings, present your work, engage with their research group.
...
```
    ...
    ║                                                  ║
    ║  What you think: "I don't belong here. Everyone  ║
    ║  else is smarter. They'll figure out I'm a       ║
    ║  fraud any day now."                             ║
    ║                                                  ║
    ║  The reality: You passed admissions. You've      ║
    ║  produced results. Your advisor chose to work    ║
    ║  with you. The "smart" people around you also    ║
    ║  feel like frauds. EVERYONE IS FAKING IT to     ║
    ║  some degree.                                    ║
    ║                                                  ║
    ║  What helps:                                     ║
    ║  • Keep a "wins" document. Every small victory.  ║
    ║  • Talk to peers honestly. You'll find you're    ║
    ║    not alone.                                    ║
    ║  • Compare yourself to past-you, not to others.  ║
    ║  • Remember: PhDs are DESIGNED to make you feel  ║
    ║    inadequate. That confusion is the process,    ║
    ║    not a sign of failure.                        ║
    ╚══════════════════════════════════════════════════╝
```

### Work-Life Balance (The Realistic Version)
...
1. **Attend conferences.** Not just the talks — the social events, coffee breaks, and poster sessions.
2. **Present posters.** They're the best networking tool because people come to you and you have 1-on-1 conversations.
3. **Ask good questions at talks.** "I really liked your work on X. I'm doing something related with Y. Could we chat later?" This works.
4. **Twitter/X academic community.** Share your papers, engage with others' work, comment thoughtfully. Many collaborations start here.
5. **Email researchers you admire.** "Dear Prof. X, I read your paper on Y with great interest. I'm working on Z and I see a potential connection..." Keep it short, specific, and genuine.
6. **Collaborate.** Co-authoring a paper is the strongest academic bond you can form.
7. **Be helpful.** Share code, answer questions, give honest feedback on others' manuscripts. Generosity compounds.

### Conference Networking Tips

```
BEFORE THE CONFERENCE
  • Research the speaker list. Identify 3-5 people you want to meet.
  • Prepare a 30-second "elevator pitch" of your research.
  • Bring business cards or have a clean personal website ready.

DURING THE CONFERENCE
  • Sit in the front rows (speakers notice you).
  • Ask at least one question per session you attend.
  • Approach people during coffee breaks, not during talks.
  • "What are you working on?" is the best conversation starter.
  • Eat meals with different groups each time. Don't just stick with
    your lab.

AFTER THE CONFERENCE
  • Follow up within 1 week. "It was great meeting you at X. I enjoyed
    our conversation about Y."
  • Connect on LinkedIn / academic social media.
  • Share their interesting work on your social channels.
...
>
> There were moments during my PhD when I wanted to quit. Real, serious, "I'm going to open LinkedIn and apply for industry jobs right now" moments. There was a month where nothing worked — experiments failed, writing was terrible, I felt completely stuck.
>
> What kept me going was honestly quite simple:
>
> 1. **Remembering why I started.** I genuinely love understanding how things work. That curiosity didn't disappear; it was just buried under stress.
>
> 2. **Taking it one day at a time.** "Finish the PhD" is overwhelming. "Run one more experiment today" is manageable.
>
> 3. **Talking to other PhD students.** Discovering that EVERYONE struggles, not just me. The people who look like they have it together? They're struggling too. They're just not showing it.
>
> 4. **Celebrating small wins.** Got a clean compile of LaTeX? Win. Got one experiment to produce sensible results? Win. Wrote 300 words? Win.
>
> 5. **Accepting that confusion is normal.** A PhD is fundamentally about doing something nobody has done before. Of course you'll be confused. If you weren't, the problem wouldn't be novel.
>
> The PhD will change you. You'll learn not just about your research topic, but about yourself — your limits, your resilience, your capacity to grow. It's hard. It's supposed to be hard. And it's worth it.
...
2. **Create** a new branch (`git checkout -b add-my-tip`)
...
```
    ...
    │   You just need to be the most persistent.                 │
    │                                                            │
...
<p align="center">
  Built with hard-won experience by <a href="https://github.com/mlnjsh"><strong>Prof. Milan Amrut Joshi</strong></a>
  <br>
  <a href="mailto:mlnjsh@gmail.com">mlnjsh@gmail.com</a> · <a href="https://github.com/mlnjsh">GitHub</a> · <a href="https://scholar.google.com">Google Scholar</a>
  <br><br>
  <em>If this helped you, consider giving it a</em> ⭐ <em>— it helps others find it too.</em>
  <br><br>
  <strong>15+ publications</strong> · <strong>SCI/SCIE/Scopus indexed</strong> · <strong>Best Paper Award @ ICIVC-2021</strong>
</p>
